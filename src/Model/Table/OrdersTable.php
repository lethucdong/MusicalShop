...
class OrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('payment_div')
            ->maxLength('payment_div', 3)
            ->requirePresence('payment_div', 'create')
            ->notEmptyString('payment_div');

        $validator
            ->scalar('delivery_div')
            ->maxLength('delivery_div', 3)
            ->requirePresence('delivery_div', 'create')
            ->notEmptyString('delivery_div');
