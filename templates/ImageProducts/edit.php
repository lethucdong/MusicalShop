...
//  Class Name      : add
//  Overview        : Thay đổi Image sản phẩm
//  Programmer      : DongLT
...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $imageProduct->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $imageProduct->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="imageProducts form content">
            ...
            <fieldset>
                <legend><?= __('Edit Image Product') ?></legend>
                <?php
